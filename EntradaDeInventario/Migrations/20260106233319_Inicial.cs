...
namespace EntradaDeInventario.Migrations
{
    /// <inheritdoc />
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 450.00m, "Laptop HP Pavilion 15", 0, 650.00m },
                    { 2, 15.00m, "Mouse Inalámbrico Logitech", 0, 25.00m },
                    { 3, 35.00m, "Teclado Mecánico RGB", 0, 55.00m },
                    { 4, 120.00m, "Monitor Samsung 24 pulgadas", 0, 180.00m },
                    { 5, 200.00m, "Audífonos Sony WH-1000XM4", 0, 300.00m }
                });
